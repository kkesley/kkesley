            ...
            <div className="columns">
                <div className="column is-one-third">
                    <div className="content is-medium">
                        ...
                        <p className="subtitle is-5">User experience is critical to the success of an application. Efficient interaction with beautiful interface are always in my priorities.</p>
                    </div>
                </div>
                <div className="column is-one-third">
                    <div className="content is-medium">
                        ...
                        <p className="subtitle is-5">I love creating scalable system by creating components and combining them. It's always been my passion to architect systems, specifically in AWS.</p>
                    </div>
                </div>
                <div className="column is-one-third">
                    <div className="content is-medium">
                        ...
                        <p className="subtitle is-5">Either SQL or NoSQL, I'm passionate in structuring data for a system. I believe efficient data structures can have a big impact on system qualities.</p>
                    </div>
                </div>
            </div>
        </div>
