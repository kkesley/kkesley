...
export default ({ personal_detail, careers, projects, skills, educations }) => () => {
  PDFMake.createPdf({
    header: {
        columns: [
            'Resume - Kendrick Kesley',
            { text: `generated on: ${dayjs().format('DD MMM YYYY HH:mm:ss Z')}`, alignment: 'right' }
        ],
        color: '#808080', //grey
        fontSize: 8,
        margin: [40, 12, 40, 0]
    ...
    content: [
            ...
            stack: [
                ...
                horizontalLine(),
                {
                    text: [
                        ...
                        ' | ',
                        { text: personal_detail.email, link: `mailto:${personal_detail.email}`, style: 'link' },
                        ' | ',
                        { text: 'https://kkesley.com', link: 'https://kkesley.com', style: 'link' },
                    ],
                },
            ],
        },
        ...
        //START: CAREER
        {
            stack: [
                ...
                careers.map(career => ({
                    stack: [
                        { text: `${career.title} | ${career.company} | ${career.year}`, style: 'item_title' },
                        {
        ...
        //START: PROJECTS
        {
            stack: [
                ...
                projects.map(project => ({
                    stack: [
                        { text: `${project.title} | ${project.year}`, style: 'item_title' },
                        {
        ...
        //START: EDUCATION
        {
            stack: [
                ...
                educations.map(education => ({
                    stack: [
                        { text: `${education.title} | ${education.year_completion}`, style: 'item_title' },
